-- Apply pending migrations that haven't reached the remote DB yet.

-- Migration 20260610100958: Remove duplicate policy + revoke preview_token
...
-- Migration 20260611120000: Insert Love Key Guardian route catalogue variants
